...
export class ProfileEntity1691035719034 implements MigrationInterface {
  ...
  public async up(queryRunner: QueryRunner): Promise<void> {
    ...
    await queryRunner.query(
      `ALTER TABLE "profiles" ADD CONSTRAINT "FK_1145146862f40fe12c6d30987c2" FOREIGN KEY ("userEntityId") REFERENCES "users"("id") ON DELETE NO ACTION ON UPDATE NO ACTION`,
    );
  }
