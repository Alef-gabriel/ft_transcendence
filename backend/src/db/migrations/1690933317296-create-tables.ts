...
export class CreateTables1690933317296 implements MigrationInterface {
  name = 'CreateTables1690933317296';

  public async up(queryRunner: QueryRunner): Promise<void> {
    await queryRunner.query(
      `CREATE TABLE "users" ("id" integer NOT NULL, "email" character varying NOT NULL, "username" character varying NOT NULL, "displayName" character varying NOT NULL, "profileUrl" character varying NOT NULL, "otpEnabled" boolean NOT NULL DEFAULT false, "otpValidated" boolean DEFAULT false, "otpSecret" character varying, "avatar" character varying, "nickname" character varying, CONSTRAINT "PK_a3ffb1c0c8416b9fc6f907b7433" PRIMARY KEY ("id"))`,
    );
    await queryRunner.query(
